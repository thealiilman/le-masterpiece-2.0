$(function() {
	...
	$("#about").on("click", function(){
		$("html, body").animate({
			scrollTop: $("#about-container").offset().top-48}, 2000);
	});
	$("#services").on("click", function(){
		$("html, body").animate({
			scrollTop:$("#services-container").offset().top-48}, 2000);
	});
	$("#portfolio").on("click", function(){
		$("html, body").animate({
			scrollTop:$("#portfolio-container").offset().top-48}, 2000);
	});
	$("#contact").on("click", function(){
		$("html, body").animate({
			scrollTop:$("#contact-container").offset().top-48}, 2000);
	});
});